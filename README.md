...
| `meanDepthOfCoverageDeviation`               | Percent deviation of provided coverage (`meanDepthOfCoverageProvided`) from computed coverage (`meanDepthOfCoverage`), relative to the computed value.                                                                                                                                                             |
...
| `percentBasesAboveQualityThresholdDeviation` | Percent deviation of provided metric (`percentBasesAboveQualityThresholdProvided`) from computed metric (`percentBasesAboveQualityThreshold`), relative to the computed value.                                                                                                                                     |
...
| `targetedRegionsAboveMinCoverageDeviation`   | Percent deviation of provided metric (`targetedRegionsAboveMinCoverageProvided`) from computed metric (`targetedRegionsAboveMinCoverage`), relative to the computed value.                                                                                                                                         |
